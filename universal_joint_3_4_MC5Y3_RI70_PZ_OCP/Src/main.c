...
static void MX_DMA_Init(void)
{
  ...
  HAL_NVIC_SetPriority(DMA1_Channel1_IRQn, 7, 1);
  HAL_NVIC_EnableIRQ(DMA1_Channel1_IRQn);
  /* DMA1_Channel4_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA1_Channel4_IRQn, 7, 1);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BC_ENABLE_GPIO_Port, BC_ENABLE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BC_ENABLE_Pin */
  GPIO_InitStruct.Pin = BC_ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BC_ENABLE_GPIO_Port, &GPIO_InitStruct);
